...
package org.opendaylight.aaa.shiro.filters.backport;
...
public class BearerHttpAuthenticationFilter extends HttpAuthenticationFilter {
    ...
    protected boolean isLoginAttempt(String authzHeader) {
        ...
        return authzHeaderLowerCase.startsWith(authzScheme)
                || authzHeaderLowerCase.startsWith(BEARER);
    }
